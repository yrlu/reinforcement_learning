...
parser.add_argument('-e', '--episodes', default=50, type=int, help='number of episodes')
parser.add_argument('-l', '--log_dir', default='/tmp/mountaincar-log-0', type=str, help='log directory')
  ...
  for i in xrange(NUM_EPISODES):
    ...
    for t in xrange(MAX_STEPS):
      ...
      if (i % EVALUATE_EVERY) == 0:
        ...
        # action = agent.get_action_noise(cur_state, sess, rate=0.01)[0]
